    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm font-body">Cargando Fe Eterna...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path="/cursos/:courseId" element={<CourseLessons />} />
        <Route path="/cursos/:courseId/:lessonId" element={<LessonPage />} />
